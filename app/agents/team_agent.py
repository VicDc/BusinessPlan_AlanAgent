...
class TeamAgent(BaseAgent):
    ...
    async def process(
        ...
        raw = await self.llm.generate(
            system_prompt=TEAM_AGENT_PROMPT,
        ...
        try:
            ...
            return AgentOutput(
                ...
                data=data,
                confidence=data.get("confidence", 0.7),
                reasoning="Analisi organizzativa del team completata.",
